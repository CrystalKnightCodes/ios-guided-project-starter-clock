...
class ClockView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        if let context = UIGraphicsGetCurrentContext() {
            ...
            // clock's border
            context.addEllipse(in: CGRect(x: rect.origin
                .x + borderWidth / 2.0,
                                          y: rect.origin
                    .x + borderWidth / 2.0,
...
//            let digitalTimeString = "\(timeComponents.hour ?? 0): \(timeComponents.minute)" as NSString
//
//            let hourX = clockCenter.x
//            let houry = clockCenter.y + 48
//            digitalTimeString.draw(in: <#T##CGRect#>, withAttributes: <#T##[NSAttributedString.Key : Any]?#>)
//
            
             // Day Label
            let weekdayString: String
            switch timeComponents.weekday ?? 0 {
                case 1:
                weekdayString = "Sun"
                case 2:
                weekdayString = "Mon"
            ...
            let dayString = "\(timeComponents.day ?? 0)" as NSString
                       let dayOriginX = clockCenter.x + 50
                       let dayOriginY = clockCenter.y
            weekdayString.draw(in: CGRect(x: dayOriginX, y: dayOriginY, width: 200, height: digitFont.lineHeight), withAttributes: [NSAttributedString.Key.foregroundColor: digitColor, NSAttributedString.Key.font: digitFont])
            ...
            let secondsCircleRect = CGRect(x: clockCenter.x - smallDotRadius,
